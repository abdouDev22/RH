    ...
    $id_offres=$_GET['id'];
       ...
       while($row=mysqli_fetch_array($req)){
        ...
        <a href="offre.php" class="retourne"><b>retour</b><i></i></a>
          ...
          <a href="post.php?id=', $row[0],' &ids=', $row[1], ' " class="postuler">Postuler</a><br><br><br>
          <div class="h1">Poste pour un(e): <span>', $row[1], '</span></div><br>
          <div class="h2">Description de l\'offre</div><br>
          <p class="descip">
          ',$row[2],'
          </p>
          <p class="datep">Date de publication : <span>',$row[3],'</span></p>
          <p class="datel">Date limite : <span>',$row[4],'</span></p> <br>
          <a href="post.php?id=',$row[0],' &ids=',$row[1],' " class="postuler1">Postuler</a>
