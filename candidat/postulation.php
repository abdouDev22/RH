...
<?php
    ...
    candidats.id_candidats=postuler.id_candidats and utilisateurs.id_utilisateurs= 
 candidats.id_utilisateur  and candidats.id_candidats='$login' ");
...
<div class="item">
          <div class="item-content">
            <h3 id="list" class="offre">',$b,'</h3>
            
            <p><strong> Date de publication:</strong>  <span class="date"> ',$d,'</span></p>
            <p><strong> Date limite:</strong> ',$e,'</p>
            <p><strong> Date postulation:</strong> ',$f,'</p>
            <a href="postulation_des.php?id=',$a,' &titre=',$b,' " class="voire" onclick="menuToggles();" style="--clr:rgb(2, 2, 198);">
    <span>modifier</span>
    <i></i></a>
    <a href="des.php?id=',$g,' &titre=',$b,' " class="voires" onclick="menuToggles();" style="--clr:rgb(2, 2, 198);">
    <span>Renoncer</span>
    <i></i></a>
