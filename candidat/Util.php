...
toggle.addEventListener('click', (e) => {
  ...
  <body><aden>
        ...
        <div class="containerd">
          <div class="title">change le mot de passe</div>

          <div class="contentd">
            <form action="#" method="POST">
              <div class="user-detailsd">
                
                
                
                <div class='input-boxd'>
                  <span class='detailsd'>ancien</span>
                  <input type='password'  name='ancien' required>
                </div>
                
                <div class='input-boxd'>
                  <span class='detailsd'>nouveau</span>
                  <input type='password'  name='nouveau'  required>
                </div>
                
                <div class='input-boxd'>
                  <span class='detailsd'>confirme</span>
