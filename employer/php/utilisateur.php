...
if (isset($_SESSION['id']) && isset($_SESSION['id_utilisateur'])) {
...
<body>
  ...
  <form action="../php/utilisateur_modify.php" method="POST" class="form">
    <span class="item"><a href="../php/profil.php" class="retourne"><b>retour</b><i></i></a></span>
    <span class="item2">Mot de passe actuel :</span>
    <span class="item2S1"><input type="password" name="ancien" required></span>
    <span class="item9">Nouveau mot de passe :</span>
    <span class="item9S"><input type="password" name="pass" required></span>
    <span class="item91">Confirmer mot de passe :</span>
    <span class="item9S1"><input type="password" name="con" required></span>
    <span class="lien-conn2"><input type="submit" name="mod" value="Modifier"></span>
  </form>
