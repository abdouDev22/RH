...
<body>
  ...
  <?php
    ...
    $resultat = mysqli_query($sum, "SELECT * FROM utilisateurs  WHERE id_utilisateurs='$id'");
  ...
  <form action="../php/utilisateur_modify.php" method="POST" class="form">
    ...
    <span class="item2">Nom d utilsateur :</span>
    <span class="item2S1"><input type="text" name="nom" value="'.$nom.'"></span>
    <span class="item9">Mot de passe :</span>
    <span class="item9S"><input type="password" name="pass" value="'.$motdepasse.'"></span>
