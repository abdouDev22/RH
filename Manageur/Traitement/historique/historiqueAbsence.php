...
<body>
    ...
    <div class="desdosiier">
        ...
        <h1 class="titre">Historique d'Absence </h1>
        <div class="nb"><?php
$serveur = "localhost";
$utilisateur = "root";
$motdepasse = "";
...
$resultat = mysqli_query($sum, "SELECT COUNT(*) AS total_absences FROM absences 
...
?>
  ...
  $resultat = mysqli_query($sum, "SELECT DISTINCT* FROM absences 
    ...
    INNER JOIN type_absences ON type_absences.id_type_absences = absences.id_type_absences 
    WHERE id_employe = '$id_employe' AND Statut_Justificatif='En-attente' AND T_manager='En-attente' 
    ORDER BY absences.dateCreation DESC");
          ...
          echo '
              <div class="item1">
                <div class="item1-content">
                  <span class="no">No :</span> <span class="no1">'.$i.'</span>
                  <span class="dateD">Date de debut</span><span class="dateD1">'.$b.'</span>
                  <span class="datef">Date de fin</span><span class="datef1">'.$c.'</span>
                </div>
              </div>
              ';}}?>
        </div>
