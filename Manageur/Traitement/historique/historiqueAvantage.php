...
<body>
    ...
    <div class="desdosiier">
        ...
        <h1 class="titre1">Historyque des avantage sociale </h1>
        <div class="nb"><?php
$serveur = "localhost";
$utilisateur = "root";
$motdepasse = "";
...
$resultat = mysqli_query($sum, "SELECT COUNT(*) AS total_avantages_sociaux  FROM  employes 
...
$totalSanctions = $row['total_avantages_sociaux'];
...
?>
  ...
  $resultat = mysqli_query($sum, "SELECT DISTINCT* FROM employes 
    INNER JOIN avantages_sociaux  ON employes.id_employe = avantages_sociaux.id_employe 
          ...
          echo '
              <div class="item1">
                <div class="item1-content">
                  ...
                  <span class="dateD">Date de debut</span><span class="dateD1">'.$h.'</span>
