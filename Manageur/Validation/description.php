...
echo'
    <a href="consultationAbsence.php" class="retourne r"><b>retour</b><i></i></a>
    <h1 class="titre">Absence</h1>
    <span class="no">No :</span><span class="no1"><input type="number" value="'.$i.'"></span>
    <span class="datcre">Date de creation</span><span class="datcre1"><input type="date" value="'.$h.'"></span>
    ...
    <div class="descrip1"><textarea name="" id="" cols="30" rows="10" >'.$e.'</textarea></div>
      ';?>
  </div>
