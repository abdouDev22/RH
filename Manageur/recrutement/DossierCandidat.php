...
$resul = mysqli_query($connexion, "SELECT * FROM offres, postuler, candidats WHERE 
    ...
    candidats.id_candidats = postuler.id_candidats AND postuler.id_candidats = '$login' ");
...
$resuls = mysqli_query($connexion, "SELECT * FROM postuler WHERE id_offre = '$lo' and id_candidats ='$login' ");
...
echo '
<span class="cv lien">
    <a href="/RH/RH/document/' . $cv . '" download="CV">CV</a>
</span>
<span class="lien let">
    <a href="/RH/RH/document/' . $lettre_motivation . '" download="Lettre de Motivation">Lettre de Motivation</a>
</span>';
