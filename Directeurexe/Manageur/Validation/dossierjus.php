...
<body>
    ...
    <div class="des">
        ...
        <h1 class="titre">Dossier de justificatif</h1>
        
<?php

$connect=mysqli_connect("localhost","root","","rh");
$id=$_GET["id"];
$resultat = mysqli_query($connect, "SELECT DISTINCT * FROM absences
...
$i=$ligne["Chemin_Fichier"];
    echo'
        ...
        <div class="descrip1"><textarea name="" id="" cols="30" rows="10" >'.$p.'</textarea></div>
          <span class="lien valider"><a href="valide.php?id='.$id.'"><B>valider</B></a></span>
          <span class="lien refuser"><a href="refuse.php?id='.$id.'"><B>Refuser</B></a></span>
          ';}}?>
      </div>
      ...
      <script>
        tippy('.d1s', {
          content:'<strong class="f" style="font-size: 1.5em;">Telegarger l\'image</strong>',
          animation:'tada',
          inertia: true,
          flip: true,
          theme: 'S1',
