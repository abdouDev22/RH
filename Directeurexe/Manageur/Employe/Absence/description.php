...
$e=$ligne["Description_Justificatif"];
  ...
  <div class="des">
    ...
    <span class="datcre">Date de creation</span><span class="datcre1"><input type="date" value="'.$h.'" readonly></span>
    <span class="type">Type d Absence</span><span class="type1"><input type="text" value="'.$a.'" readonly></span>
    ...
    <div class="descrip1"><textarea name="" id="" cols="30" rows="10" >'.$k.'</textarea></div>
      <span class="lien-Mod"><input type="submit" value="Justifier"></span>  
  </div>
';?>
