...
$resultat = mysqli_query($sum, "SELECT * FROM contact ");
    ...
    echo '
        <div class="item">
            <div class="item-content">
                <span class="nom">Nom</span><span class="nom1"><input type="text" value="' . $a . '" readonly></span>
                <span class="email">Email</span><span class="email1"><input type="email" value="' . $x . '" readonly></span>
                <span class="message">Message</span>
                <textarea name="" id="" cols="30" rows="10" readonly>' . $i . '</textarea>
            </div>
        </div>';
}
?>
