...
$req=mysqli_query($connect, "SELECT DISTINCT* FROM demande_congé
INNER JOIN type_conge ON demande_congé.id_type_conge = type_conge.id_type_conge
INNER JOIN employes ON employes.id_employe = demande_congé.id_employe
...
<head>
    ...
    <link rel="stylesheet" href="assetes/acdicteur.css">
...
<body>
    ...
    <a href="commentaire.php" class="Commentaire">Commentaire</a>
      <ul>
...
?>
    <div class="item">
      <div class="item-content">
        <span class="no">Nom :</span><span class="no1"><input type="text" value="<?php echo$row["nom"]; ?>"></span>
        <span class="type">Type de congé</span><span class="type1"><?php echo$row["type_conge"]; ?></span>
        <span class="statut">Statut: </span> <span class="statut1"><?php echo$row["statut"]; ?></span>
        <span class="datedeb"><strong> Date de Debut:</strong></span> <span class="datedeb1 date"><?php echo$row["date_début"]; ?></span>
        <span class="datelim"><strong> Date fin:</strong></span> <span class="datelim1"><?php echo$row["date_fin"]; ?></span>
        <a href="dosier.php?id=<?php echo $row["id_employe"]; ?>&& id_conge=<?php echo $row["id_congé"]; ?>" class="voire" style="--clr:rgb(2, 2, 198);"><span>Traitement</span><i></i></a>
      </div>
    </div>
    <?php
  }
