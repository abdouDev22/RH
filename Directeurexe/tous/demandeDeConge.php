...
$query_clients = "SELECT DISTINCT* FROM demande_congé,type_conge where id_employe=$id_employe and demande_congé.id_type_conge = type_conge.id_type_conge ORDER BY id_congé DESC" ;
...
?>
    ...
    <div class="desdosiier1">
        ...
        <h1 class="titre">Demande de conge </h1>
      ...
      if ($result_clients->num_rows > 0) {
        while ($row = $result_clients->fetch_assoc()) {
            ...
            <div class="item-content">
              ...
              <span class="date">Date de debut :</span><span class="date1"><?php echo $row['date_début']; ?></span>
        ...
        ?>
        <script>
            alert("Employe sans Demande de conge");
