...
$sql_Sanction=  "SELECT DISTINCT* FROM sanctions, type_sanctions WHERE sanctions.id_type_sanctions = type_sanctions.id_type_sanctions and id_employe=$id_employe  ORDER BY id_sanctions DESC ";
        ...
        while ($row = $result_sanction->fetch_assoc()) {
            ...
            <div class="item1">
                <div class="item1-content">
                  ...
                  <span class="dateD">Date de debut</span><span class="dateD1"><?php echo $row['date_sanction']; ?></span>
